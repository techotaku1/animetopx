...
export const carouselData = [
  // Portada 0
  {
    id: 0,  // ID único para la primera portada
  ...
  // Portada 3
  {
    id: 3,  // ID único para la primera portada
  ...
  // Portada 2
  {
    id: 2,  // ID único para la segunda portada
  ...
  // Portada 1
  {
    id: 1,  // ID único para la tercera portada
  ...
  // Noticias 1
  {
    id: 1,  // ID único para la noticia 3
    title: "TOP ANIME OTOÑO 2024",
