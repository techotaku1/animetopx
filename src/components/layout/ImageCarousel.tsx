...
export function ImageCarousel({
	...
	return (
		<div className="relative mb-8 w-full lg:mb-0 lg:w-1/2">
			...
			<Button
				aria-label="Previous"
				className="bg-primary text-primary-foreground absolute left-0 top-1/2 ml-4 -translate-y-1/2 transform rounded-full p-3 transition-transform duration-200 ease-out hover:scale-110 hover:bg-black/70 active:scale-90"
				onClick={onPrev}
			>
			...
			<Button
				aria-label="Next"
				className="bg-primary text-primary-foreground absolute right-0 top-1/2 mr-4 -translate-y-1/2 transform rounded-full p-3 transition-transform duration-200 ease-out hover:scale-110 hover:bg-black/70 active:scale-90"
				onClick={onNext}
			>
